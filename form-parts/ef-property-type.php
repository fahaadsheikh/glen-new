<div class="form-group row">
  ...
  <div class="col-sm-8">
    <select id="property-type" name="property-type" class="custom-select">
		...
		<option value="Townhouse"><?php echo __( 'Townhouse', 'dym' ) ?></option>
		<option value="Land"><?php echo __( 'Land', 'dym' ) ?></option>
		<option value="Acreage"><?php echo __( 'Acreage', 'dym' ) ?></option>
		<option value="Apartment/Unit"><?php echo __( 'Apartment/Unit', 'dym' ) ?></option>
		<option value="Duplex"><?php echo __( 'Duplex', 'dym' ) ?></option>
    </select>
  </div>
</div>